  ...
  useEffect(() => {
    const fetchEmployees = async () => {
      ...
      try {
        ...
        const { data } = await axios.get(`${BASE_URL}/api/users/employees`, config);
  ...
  return (
    <form className="task-form" onSubmit={handleSubmit} aria-label="Task Form">
      ...
      <div className="task-form__group">
        <label htmlFor="taskText" className="task-form__label">Task</label>
        <input
          type="text"
          id="taskText"
      ...
      <div className="task-form__group">
        <label htmlFor="assignedTo" className="task-form__label">Assign To</label>
        <select
          id="assignedTo"
          className="task-form__input"
          value={assignedTo}
