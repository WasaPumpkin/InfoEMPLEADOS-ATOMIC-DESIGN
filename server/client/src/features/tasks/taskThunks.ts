...
//       return await fetchTasksAPI(auth.userInfo?.token || '');
//     } catch (error) {
...
//     try {
//       const { auth } = getState() as RootState;
//       return await createTaskAPI(payload, auth.userInfo?.token || '');
//     } catch (error) {
//       return rejectWithValue(
...
//     try {
//       const { auth } = getState() as RootState;
//       return await deleteTaskAPI(taskId, auth.userInfo?.token || '');
//     } catch (error) {
//       return rejectWithValue(
...
//     try {
//       const { auth } = getState() as RootState;
//       return await completeTaskAPI(payload, auth.userInfo?.token || '');
//     } catch (error) {
//       return rejectWithValue(
...
//     try {
//       const { auth } = getState() as RootState;
//       return await editTaskAPI(payload, auth.userInfo?.token || '');
//     } catch (error) {
//       return rejectWithValue(
